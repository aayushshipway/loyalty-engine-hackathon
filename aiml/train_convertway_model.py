...
# Feature engineering
df_txn['register_convertway'] = pd.to_datetime(df_txn['register_convertway'])
df_txn['merchant_age_days'] = (datetime.now() - df_txn['register_convertway']).dt.days
...
# Define features (limited to available ones)
features = [
